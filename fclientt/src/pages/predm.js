    ...
    //     };
      ...
      <div class="row align-items-center">
       ...
       {snipper ? ( <div class="d-flex flex-column align-items-center">
           <h3>Prediction in minutes</h3><p>(Max number=180)</p>
           <input class="form-control" type="text" value={nbrm} style={{ width: '200px', fontSize: '14px' }} onChange={(e) => setNbrm(e.target.value)}  aria-label="default input example"></input>
